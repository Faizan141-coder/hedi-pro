      ...
      <footer className="border-t h-[65px]">
        <div className="ml-5 flex space-x-3 items-center h-full">
          ...
          <div className="justify-between flex w-full px-10">
            <Image src="/google.svg" alt="google icon" width={40} height={40} className="cursor-pointer" />
            <Image src="/trustpilot.svg" alt="trustpilot icon" width={40} height={40} className="cursor-pointer" />
            <Image src="/google-playstore.svg" alt="playstore icon" width={40} height={40} className="cursor-pointer" />
            <Image src="/app-store.svg" alt="appstore icon" width={40} height={40} className="cursor-pointer" />
            <Image src="/instagram.svg" alt="instagram icon" width={40} height={40} className="cursor-pointer" />
            <Image src="/tiktok.svg" alt="tiktok icon" width={40} height={40} className="cursor-pointer" />
            <Image src="/twitterx.svg" alt="xtwitter icon" width={40} height={40} className="cursor-pointer" />
            <Image src="/reddit.svg" alt="reddit icon" width={40} height={40} className="cursor-pointer" />
          </div>
        </div>
      </footer>
    </div>
